package com.askfolio.mainsite.config;
...
@Configuration
@EnableMongoRepositories("com.askfolio.mainsite.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory) throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.askfolio.mainsite.config.dbmigrations");
